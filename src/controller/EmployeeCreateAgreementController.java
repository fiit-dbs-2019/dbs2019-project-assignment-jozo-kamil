...
public class EmployeeCreateAgreementController implements Initializable {
    ...
    public void btnLegalPushed(ActionEvent actionEvent) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("../view/employee_create_contract_legal_person.fxml"));
        rootPane.getChildren().setAll(pane);
    }

    public void btnNaturalPushed(ActionEvent actionEvent) throws IOException{
        AnchorPane pane = FXMLLoader.load(getClass().getResource("../view/employee_create_contract_natural_person.fxml"));
        rootPane.getChildren().setAll(pane);
    }
